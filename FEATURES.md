...
- `last_checked`: `2026-04-29`
- `quality`: `k28b_operational_narrow_free_class1_green`
- `known_gap`: Die Builder-Pipeline ist jetzt ueber vier enge code-adjacent class_1-Familien live gruen und hat zusaetzlich einen belastbaren freien Docs-/Helper-plus-repeatable-Runtime-class_1-Subset mit drei freien Runtime-Beweisen. `K2.8a` zeigte danach die erste echte operative Grenze dieses freien Korridors: non-governance Anchored-Replacement landete gruen auf `2dbab36`, aber ein Append auf einer groesseren Docs-Datei und ein drei-zeiliger Helper-Create-Target blieben bewusst fail-closed. `K2.8b` loeste genau diese Frage nicht durch Widening, sondern durch engeren Zuschnitt: tiny helper append `2ee184b` und single-line helper create-target `10d4e13` landeten sauber und live. Offen bleibt damit weniger die technische Existenz des engen freien Korridors als seine bewusste operative Nutzung und die harte Grenze gegen groessere Helper-/Docs-Operationen, breitere Runtime-Arbeit und Builder-Core-Arbeit.
- `next_recommended_step`: Keinen neuen UI-, Patrol- oder breiten Feature-Block aufmachen. Als naechstes den engen freien class_1-Korridor bewusst operativ nutzen: exakte Docs-/Helper-Landings, non-governance Anchored-Replacements in Docs-/Helper-Pfaden, tiny helper append, single-line helper create-targets und exakte single-file public-route validation/guard fixes mit direkter Live-Probe. Kein Multi-File, kein Builder-Core, keine Secrets-/Deploy-/Provider-Core-Ziele, keine freien Anchored-Replacements auf Governance-/Policy-Dokumenten und keine groesseren Docs-Append-/mehrzeiligen Create-Target-Aufgaben ohne neues Hardening. Wenn danach noch technische Arbeit folgt, dann eher ein gezielter K2.8a-Hardening-Block statt neuer Widening-Experimente.
