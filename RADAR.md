...
- `why_not_now`: `Der freie Docs-/Helper-class_1-Korridor ist jetzt nicht nur ueber K2.7a bis K2.7c belastbar, sondern durch `K2.8b` auch in einem echten engen Operations-Subset gruen. Gerade deshalb ist jetzt nicht der Moment fuer breite freie Builder-Autonomie, sondern fuer die bewusste operative Nutzung dieses schmalen Korridors statt weiterer nahezu gleicher Evidenz-Loops.`
...
- `kurzurteil`: Der Acceptance-Korridor ist jetzt nicht mehr nur evidenzstark, sondern in einer engen Form operativ nutzbar. Der schmale K2.6b-Live-Subset blieb auf matching Live-Heads `96fc618` und `9f978e6` gruen 5/5; K2.6c landete komplett gruen im Docs-/Helper-Corridor; `427235a`, `52a7175`, `adc593a` und `abd1d3f` fuegten danach echte code-adjacent Cleanup-/Guard-/Validation-Faelle hinzu. Mit `7c3bce7`, `21d7a3d`, `0b2b8c3` und `ef100dd` ist der freie Docs-/Helper-class_1-Korridor inklusive non-governance Anchored-Replacements repo-sichtbar belegt. `1512f95`, `b6b85d0` und `0702adc` erweitern diese Linie in drei freie code-adjacent Runtime-Faelle. `K2.8a` zeigte die ehrliche operative Grenze, `K2.8b` den gruenen engeren Ops-Schnitt. Offen bleibt damit nicht mehr primaer die technische Repeatability, sondern die bewusste Governance-Entscheidung, wie weit genau dieser freie Korridor offiziell genutzt werden soll.
