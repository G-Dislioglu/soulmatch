...
- `why_not_now`: `Der freie Docs-/Helper-class_1-Korridor ist jetzt ueber K2.7a bis K2.7c belastbar genug, dass die naechste Arbeit nicht mehr im selben Docs-/Helper-Kreis kreisen sollte. Der sinnvolle Rest ist jetzt enger und riskanter zugleich: keine breite freie Builder-Autonomie behaupten, sondern genau einen ersten freien code-adjacent runtime case pruefen und Governance-/Policy-Dokumente fuer anchored replacements weiter bewusst ausserhalb des freien Korridors halten.`
