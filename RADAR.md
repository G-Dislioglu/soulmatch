...
- `why_not_now`: `Der K2.6b-Live-Sync ist fuer den aktuellen Subset nicht mehr der Hauptrest. Nach dem matching Live-Run auf `96fc618` waere ein neuer Patrol-, UI- oder Feature-Block Drift; der engste sinnvolle Folgeschritt ist jetzt provider degraded-path hardening und erst danach der bewusste Release-Korridor fuer freie class_1-Familien.`
...
- `kurzurteil`: Der Acceptance-Korridor ist jetzt enger belegt als auf dem alten H3-Stand. Der schmale K2.6b-Live-Subset lief auf matching Live-Head `96fc618` gruen 5/5; die frueheren `T08`-/`T10`-Abweichungen waren damit als echter Live-Lag isoliert und sind fuer diesen Korridor geschlossen. Offen bleibt nicht mehr der reine Live-Sync, sondern die naechste bewusste Freigabeentscheidung: provider degraded-path hardening und danach ein enger K2.6c-Release-Korridor fuer freie class_1-Familien.
- `evidence`: Nicht akzeptierte Landing-Evidence `class1-builder-run-k26-t03-docfix-after-wiring-20260427-230936.json` mit `status=partial`, spaeter repo-sichtbarem Commit-Landing und der eingegrenzten Timeout-Fehlklassifikation; Reparatur-Commit `24fc1b8`; Hardening-Commits `77fbdd3`, `0619640`, `53af22a`; H2A-Commit `b2d08ea`; H2B-Commits `5c76561` und `bd9c2ef`; H2C-1-Commit `c25a4e2`; H2D-1-Commit `acb2b1b`; H2C-2-Commit `cb5f510`; H3A-Commit `1d7c6bc`; H3-async-0-Commit `307fa3d`; H3-async-1-Commit `ed27349`; main-Autonomie-Hardening `1761f3e`, `4e4c72b`, `1272ccd`, `96fc618`, Runner-Contract-Fix `fb6b767`. Repo-sichtiger Live-Report in `docs/BUILDER-BENCHMARK-K2.6B-LIVE-SUBSET-REPORT.md`; externer Ergebnisreport `C:/Users/guerc/OneDrive/Desktop/soulmatch/k26b-live-results-postsync-v2.json` mit `passCount=5`, `deviationCount=0`, `liveCommit=96fc618b88b57730fe55cd5d2bff2332ef9f101d`. Letzte live bestaetigte Runtime-Antwort ueber resolve-Pfad steht damit auf Code-Head `96fc618`.
