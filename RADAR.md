...
- `why_not_now`: `Der freie Docs-/Helper-class_1-Korridor ist jetzt ueber K2.7a bis K2.7c belastbar, und `1512f95`, `b6b85d0` plus `0702adc` haben drei freie code-adjacent Runtime-Faelle gruen nachgezogen. Gerade deshalb ist jetzt nicht der Moment fuer breite freie Builder-Autonomie, sondern fuer die bewusste Entscheidung, diesen schmalen Korridor zu fixieren und operativ zu nutzen, statt weiter nur Evidenz zu stapeln.`
...
- `kurzurteil`: Der Acceptance-Korridor ist jetzt enger und belastbarer belegt als vor dem Incident. Der schmale K2.6b-Live-Subset blieb auf matching Live-Heads `96fc618` und `9f978e6` gruen 5/5; K2.6c landete komplett gruen im Docs-/Helper-Corridor; `427235a` zeigte den ersten code-adjacent single-file Marker-Push; `52a7175`, `adc593a` und `abd1d3f` fuegten danach echte Runtime-Cleanup-/Guard-/Validation-Faelle hinzu. Mit `7c3bce7`, `21d7a3d`, `0b2b8c3` und `ef100dd` ist der freie Docs-/Helper-class_1-Korridor inklusive non-governance Anchored-Replacements repo-sichtbar belegt. `1512f95`, `b6b85d0` und `0702adc` erweitern diese Linie jetzt in drei freie code-adjacent Runtime-Faelle. Offen bleibt damit nicht mehr primär die technische Repeatability, sondern die bewusste Governance-Entscheidung, wie weit genau dieser freie Korridor offiziell reichen soll.
