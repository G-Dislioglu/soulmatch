...
- `risk`: `niedrig; der Hardening-Zwischenschritt ist live in den Phase-1-Pfad eingelassen, 910fbed reduziert die groben Prosa-False-Positives ueber code-block-aware Matching, und 0e4c075 macht Findings-, Truncation- und Signal-Counts ueber /api/architect/state sichtbar. Offen bleibt jetzt vor allem die Restpraezision der uebrigen Guard-Heuristiken an weiteren Randmustern.`
