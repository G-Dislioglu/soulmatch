...
- `why_not_now`: `Nach dem nicht akzeptierten T03-Landing-Run, der Hardening-Kette 1A/1B/1C sowie den jetzt auf main liegenden H2A-, H2B-, H2C-1-, H2D-1- und H2C-2-Schnitten bleibt ein weiterer Builder-Nutzungsnachweis bewusst nicht freigegeben; vor dem naechsten Run steht erst die getrennte H3-Entscheidung.`
