...
- `why_not_now`: `Der freie Docs-/Helper-class_1-Korridor ist jetzt ueber K2.7a bis K2.7c belastbar, und `1512f95` hat den ersten freien code-adjacent Runtime-Fall gruen nachgezogen. Gerade deshalb ist jetzt nicht der Moment fuer breite freie Builder-Autonomie, sondern fuer eine zweite enge Runtime-Wiederholung. Erst danach laesst sich entscheiden, ob eine schmale freie Runtime-Kategorie wirklich tragfaehig ist.`
