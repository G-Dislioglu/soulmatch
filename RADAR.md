...
- `why_not_now`: `K2.7a hat jetzt erstmals zwei echte freie class_1-Docs-/Helper-Landings auf `main` gebracht, aber weder daraus noch aus dem blockierten `T03` darf schon breite freie Builder-Autonomie abgeleitet werden. Der naechste sinnvolle Schritt ist jetzt enger: freie Docs-/Helper-Lane festziehen, Repeatability haerten und erst dann anchored replacements erneut pruefen.`
