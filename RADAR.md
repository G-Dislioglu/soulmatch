...
- `why_not_now`: `Der freie Docs-/Helper-class_1-Korridor ist jetzt ueber K2.7a bis K2.7c belastbar, und `1512f95` plus `b6b85d0` haben zwei freie code-adjacent Runtime-Faelle gruen nachgezogen. Gerade deshalb ist jetzt nicht der Moment fuer breite freie Builder-Autonomie, sondern fuer die bewusste Entscheidung, ob diese schmale Runtime-Lane als enger freier Korridor fixiert wird oder ob davor noch ein letzter Distinct-Route-Fall verlangt wird.`
