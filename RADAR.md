...
- `risk`: `niedrig; der Hardening-Zwischenschritt ist live in den Phase-1-Pfad eingelassen, 910fbed, a5220e1 und bf36900 nehmen jetzt sowohl die zentralen Forbidden-Patterns als auch die vier heuristischen Randchecks aus reiner Prosa heraus und schaerfen den BACKTICK-Fall innerhalb von Code weiter. Offen bleibt vor allem die Produktentscheidung ueber Severity und globale-vs-lokale Geltung einzelner Heuristiken, nicht mehr der konkrete False-Positive-Fall `/api/users` plus Backticks.`
