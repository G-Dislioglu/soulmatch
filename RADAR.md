...
- `why_not_now`: `Der K2.6b-Live-Sync, der enge degraded-provider-Schnitt und der komplette K2.6c-Docs-/Helper-Corridor sind fuer den aktuellen Korridor erledigt. Ein neuer Patrol-, UI- oder breiter Feature-Block waere Drift; der engste sinnvolle Folgeschritt ist jetzt ein erster code-adjacent K2.6d-Controlled-Push ausserhalb von docs/archive.`
