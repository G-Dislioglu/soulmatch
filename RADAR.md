...
- `next_gate`: `proposal`
- `why_not_now`: `Die fruehere K2.8a-Restoffenheit ist jetzt geschlossen, und `K2.8j` hat mit `guide.ts` bereits den naechsten engen Runtime-Kandidaten sauber gelandet. Damit gibt es im Moment keinen Pflicht-Follow-up; weitere Builder-Arbeit sollte erst wieder als neuer enger Kandidat formuliert werden.`
